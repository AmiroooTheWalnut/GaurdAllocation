...
for f=1:10
    for j=1:1
        for i=1:sizeTerrain
            ...
            [visibleFaces,visibleVerticesSizes] = calcVisibility(orig,vertices,faces,terrainPoints,isParallel);
            %             trisurf(faces,X,Y,terrainPoints,visibleFaces,'FaceAlpha',0.9,'LineWidth',0.01);
            %             hold on;
...
drawSolution(faces,X,Y,terrainPoints,d,pi_v,height);

function drawSolution(faces,X,Y,terrainPoints,d,pi_v,height)
